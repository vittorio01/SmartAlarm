...
#ifndef __SMARTALARM_RINGTONES__
#define __SMARTALARM_RINGTONES__ 
...
const char* ringtones_desctiptions[RINGTONES_NUMBER]={NOKIA_DESCRIPTION};
...
void toneHandler() {
  ringtone_Timer.stop();
   if (ring_on) {
     ...
     ringtone_Timer.begin(&toneHandler,ringtones_tones[selectedRingtone][currentTone+1]);
